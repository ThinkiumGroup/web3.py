...
from web3.account.datastructures import (
    AttributeDict,
)
from web3.account.internal.signing import (
...
from web3.account.internal.transactions import (
    Transaction,
    vrs_from,
)
from web3.account.signers.local import (
    LocalAccount,
)
...
class Account(object):
    ...
    def create(self, extra_entropy=''):
        '''
        Creates a new private key, and returns it as a :class:`~web3.account.local.LocalAccount`.
    ...
    def signHash(self, message_hash, private_key):
        ...
        you can use :meth:`~web3.account.messages.defunct_hash_message`.
        ...
        :rtype: ~web3.account.datastructures.AttributeDict

        .. code-block:: python

            >>> msg = "I♥SF"
            >>> from web3.account.messages import defunct_hash_message
